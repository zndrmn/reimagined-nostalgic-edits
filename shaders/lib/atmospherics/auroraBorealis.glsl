...
void GetAuroraColor(in vec2 wpos, out vec3 auroraUp, out vec3 auroraDown) {
    ...
    #else
        vec3 auroraUpA[] = vec3[](
            vec3(112.0, 36.0, 192.0),  // 1
            vec3(255.0, 56.0, 64.0),   // 2
            vec3(255.0, 80.0, 112.0),  // 3
            vec3(72.0, 96.0, 192.0),   // 4
            vec3(112.0, 80.0, 255.0),  // 5
            vec3(232.0, 116.0, 232.0), // 6
            vec3(212.0, 108.0, 216.0), // 7
            vec3(120.0, 212.0, 56.0),  // 8
            vec3(64.0, 255.0, 255.0),  // 9
            vec3(168.0, 36.0, 88.0),   // 10
            vec3(255.0, 68.0, 124.0),  // 11
            vec3(216.0, 8.0, 255.0),   // 12
            vec3(0.0, 255.0, 255.0),   // 13
            vec3(0.0, 20.0, 60.0)      // 14
        );
        vec3 auroraDownA[] = vec3[](
            vec3(96.0, 255.0, 192.0),  // 1
            vec3(204.0, 172.0, 12.0),  // 2
            vec3(80.0, 255.0, 180.0),  // 3
            vec3(172.0, 44.0, 88.0),   // 4
            vec3(80.0, 255.0, 180.0),  // 5
            vec3(244.0, 188.0, 28.0),  // 6
            vec3(92.0, 188.0, 180.0),  // 7
            vec3(176.0, 88.0, 72.0),   // 8
            vec3(128.0, 64.0, 128.0),  // 9
            vec3(60.0, 184.0, 152.0),  // 10
            vec3(160.0, 96.0, 255.0),  // 11
            vec3(32.0, 176.0, 33.0),   // 12
            vec3(180.0, 0.0, 0.0),     // 13
            vec3(0.0, 24.0, 36.0)      // 14
        );
