...
#define INCLUDE_SKY_COLORS
    ...
    vec3 sunsetUpSkyColor     = skyColor * vec3(0.8, 0.58, 0.58);
    vec3 sunsetMiddleSkyColor = skyColor * vec3(1.8, 1.3, 1.2);
    ...
    vec3 nightColFactor      = mix(vec3(0.07, 0.14, 0.24) + skyColor, rainNC + 20.0 * rainNC * skyColor, rainFactor) * NIGHT_BRIGHTNESS;
...
#elif defined END
    vec3 endSkyColor = vec3(E_SKY_COLORR, E_SKY_COLORG, E_SKY_COLORB) / 255.0 * E_SKY_COLORI;
#endif
